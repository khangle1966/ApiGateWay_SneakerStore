...
export class ApiService {
  ...
  getProducts() {
    ...
    return this.httpClinet.get<ProductsResponse>('http://localhost:30007/v1/Product/all', {
  ...
  postProducts(product: Products) {
    ...
    return this.httpClinet.post<WrappedProduct>(
      'http://localhost:30007/v1/Product',
      wrappedProduct
    );
  }
  ...
  getProductTotal() {
    console.log('getProducts');
    return this.httpClinet.get<ProductsResponse>('http://localhost:30007/v1/Product/total', {
    });
  }
  ...
  deleteProducts(id: number) {
    return this.httpClinet.delete<Products>(
      `http://localhost:30007/v1/Product/delete?id=${id}`,
  ...
  updateProduct(product: Products) {
    return this.httpClinet.put<Products>(
      `http://localhost:30007/Product/update?id=${product.id}`,
      product,
